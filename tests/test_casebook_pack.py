"""Regression checks for the zenith-mesh-lease-mesh casebook."""
...
from casebook.harness import assert_expected, zenith_mesh_lease_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_mesh_lease_mesh_summary(), assert_expected())
